...
void Map::drawStartMap(ALLEGRO_DISPLAY* display, ALLEGRO_BITMAP* spritesheet, bool fullscreen, bool mute, int SCREEN_W, int SCREEN_H)
{
    ...
    if(fullscreen)
    {
        ...
        al_draw_text(font1, al_map_rgb(255,241,0), TITLE_x, TITLE_y, ALLEGRO_ALIGN_CENTER, "PACBALL");
        al_draw_text(font2, al_map_rgb(255,255,255), TITLE_x-150, TITLE_y+100, ALLEGRO_ALIGN_LEFT, "GOLS");
        al_draw_textf(font2, al_map_rgb(255, 255, 255), TITLE_x-150, TITLE_y+125, ALLEGRO_ALIGN_LEFT, "%d", score);
        al_draw_text(font2, al_map_rgb(255,255,255), TITLE_x+5, TITLE_y+100, ALLEGRO_ALIGN_LEFT, "ARTILHARIA");
        al_draw_textf(font2, al_map_rgb(255, 255, 255), TITLE_x+5, TITLE_y+125, ALLEGRO_ALIGN_LEFT, "%d", highscore);
        al_draw_text(font2, al_map_rgb(255,255,255), SCREEN_W-137, SCREEN_H-72, ALLEGRO_ALIGN_CENTER, "ESC = SAIR");
        al_draw_text(font2, al_map_rgb(255,255,255), SCREEN_W-136, SCREEN_H-52, ALLEGRO_ALIGN_CENTER, "F = EXIT FULLSCREEN");
        al_draw_text(font2, al_map_rgb(255,255,255), SCREEN_W-132, SCREEN_H-32, ALLEGRO_ALIGN_CENTER, "M = MUTE ON/OFF");
        al_draw_text(font2, al_map_rgb(255, 255, 255), 9*pxSize-8, 8*pxSize+12, 0, "READY!");
        al_draw_text(font2, al_map_rgb(255,255,255), TITLE_x, 300, ALLEGRO_ALIGN_CENTER, "PRESSIONE ENTER PARA ROLAR A BOLA!");
    ...
    else
    {
        ...
        al_draw_text(font2, al_map_rgb(255,255,255), TITLE_x+5, TITLE_y+100, ALLEGRO_ALIGN_LEFT, "ARTILHARIA");
        al_draw_textf(font2, al_map_rgb(255, 255, 255), TITLE_x+5, TITLE_y+125, ALLEGRO_ALIGN_LEFT, "%d", highscore);
        al_draw_text(font2, al_map_rgb(255,255,255), (al_get_display_width(display))-137, (al_get_display_height(display))-72, ALLEGRO_ALIGN_CENTER, "ESC = SAIR");
        al_draw_text(font2, al_map_rgb(255,255,255), (al_get_display_width(display))-136, (al_get_display_height(display))-52, ALLEGRO_ALIGN_CENTER, "F = EXIT FULLSCREEN");
...
void Map::drawEndMap(ALLEGRO_DISPLAY* display, ALLEGRO_BITMAP* spritesheet, bool fullscreen, bool mute, bool win, int SCREEN_W, int SCREEN_H)
{
    ...
    if(fullscreen)
    {
        ...
        (win)? al_draw_text(font2, al_map_rgb(0,255,0), TITLE_x, 280, ALLEGRO_ALIGN_CENTER, "VOCE EH O CAMPEAO") : al_draw_text(font2, al_map_rgb(255,0,0), TITLE_x, 280, ALLEGRO_ALIGN_CENTER, "GAME OVER");
    ...
    else
    {
        ...
        (win)? al_draw_text(font2, al_map_rgb(0,255,0), TITLE_x, 280, ALLEGRO_ALIGN_CENTER, "VOCE EH O CAMPEAO") : al_draw_text(font2, al_map_rgb(255,0,0), TITLE_x, 280, ALLEGRO_ALIGN_CENTER, "VOCE PERDEU A COPA");

        // Altera o icone do auto falante que representa o som (mutado ou desmutado).
        (mute)? al_draw_bitmap_region(spritesheet, 780, 797, 20, 20, (al_get_display_width(display))-35, (al_get_display_height(display))-35, 0) : al_draw_bitmap_region(spritesheet, 780, 773, 20, 20, (al_get_display_width(display))-35, (al_get_display_height(display))-35, 0);
    }

    (win)? al_draw_text(font1, al_map_rgb(255,241,0), (mapSizeX*pxSize/2)-250, mapSizeY*pxSize/2, 0, "FIM DE JOGO!") : al_draw_text(font1, al_map_rgb(255,0,0), (mapSizeX*pxSize/2)-250, mapSizeY*pxSize/2, 0, "VOCE PERDEU A COPA");
}
